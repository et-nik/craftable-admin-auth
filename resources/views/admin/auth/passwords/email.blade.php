...
@section('title', trans('craftable/admin-auth::admin.forgot_password.title'))
							...
							<auth-form
								...
								<form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/password-reset/send') }}" novalidate>
									...
									<div class="auth-header">
										<h1 class="auth-title">{{ trans('craftable/admin-auth::admin.forgot_password.title') }}</h1>
										<p class="auth-subtitle">{{ trans('craftable/admin-auth::admin.forgot_password.note') }}</p>
									</div>
									<div class="auth-body">
										@include('craftable/admin-auth::admin.auth.includes.messages')
											...
											<div class="form-grou">
													...
													<button type="submit" class="btn btn-primary btn-block btn-spinner"><i class="fa"></i> {{ trans('craftable/admin-auth::admin.forgot_password.button') }}</button>
											</div>
									</div>
								</form>
							</auth-form>
