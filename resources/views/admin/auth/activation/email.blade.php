...
@section('title', trans('craftable/admin-auth::admin.activation_form.title'))
                        ...
                        <auth-form
                            ...
                            <form class="form-horizontal" role="form" method="POST"
                                ...
                                <div class="auth-header">
                                    <h1 class="auth-title">{{ trans('craftable/admin-auth::admin.activation_form.title') }}</h1>
                                    <p class="auth-subtitle">{{ trans('craftable/admin-auth::admin.activation_form.note') }}</p>
                                </div>
                                <div class="auth-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block btn-spinner"><i
                                                    class="fa"></i> {{ trans('craftable/admin-auth::admin.activation_form.button') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
